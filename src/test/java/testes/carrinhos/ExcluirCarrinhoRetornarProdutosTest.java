...
public class ExcluirCarrinhoRetornarProdutosTest extends BaseCarrinho {

    private List<String> produtos = new ArrayList<>();

    @Test
    @DisplayName("Deve excluir o carrinho cadastrado e reabastecer estoque")
    public void deveExcluirCarrinhoERetornarEstoque() {
